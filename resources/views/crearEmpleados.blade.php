...
<body>
    ...
    <form method="POST" action="{{route('empleados.guardar')}}">
      ...
      <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Codigo Prestamo</label>
        <input type="number" class="form-control" name="idprestamo" id="idprestamo" placeholder="Another input placeholder">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">APELLIDO</label>
        <input type="date" class="form-control" name="fechaingreso" id="fechaingreso" placeholder="Another input placeholder">
      </div>
      <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Salario</label>
        <input type="number" class="form-control" name="salario" id="salario"  placeholder="Another input placeholder">
      </div>
